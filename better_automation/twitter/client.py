...
class Client:
    ...
    async def swap_password(self, password: str, old_password: str) -> UserData | None:
        return await self._swap_password_action(old_password=old_password, password=password)
    ...
    async def _swap_password_action(self, old_password: str, password: str):
        ...
        return "status" in response_json
